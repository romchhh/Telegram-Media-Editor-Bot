...
def process_video_segment(segment_index, segment_start, segment_end, input_path, output_dir, **kwargs):
    ...
    segment_processor = VideoProcessor(segment_clip)
...
def process_video_in_parallel(input_path, output_dir, num_segments=4, segment_duration=None, **kwargs):
    ...
    with Pool(processes=min(num_segments, cpu_count())) as pool:
        ...
        process_segment_func = partial(process_video_segment, input_path=input_path, output_dir=output_dir, **kwargs)
